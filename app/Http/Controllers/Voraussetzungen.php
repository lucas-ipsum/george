...
class Voraussetzungen extends Controller
{
  ...
  $bot->reply('Für sind vorausgesetzte Kenntnisse: Orientierungsphase.');         //Dieser Fall wird aufgerufen, wenn die Veranstaltung in der Anfrage mit eingegeben wurde
  }
  else {
  $bot->reply('Für sind vorausgesetzte Kenntnisse: Orientierungsphase.'); //Dieser Fall wird aufgerufen, wenn die Veranstaltung aus dem Context geholt wird
